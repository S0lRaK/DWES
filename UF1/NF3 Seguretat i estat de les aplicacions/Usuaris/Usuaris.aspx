...
<asp:Content ID="ContentSection" ContentPlaceHolderID="ContentPlaceHolderSection" Runat="Server">
    <asp:Panel ID="PanelUsuari" runat="server" CssClass="panel">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorNomUsuari" runat="server" ErrorMessage="El nom d'usuari és obligatori." ControlToValidate="TextBoxNomUsuari"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorContrasenya" runat="server" ErrorMessage="La contrasenya és obligatoria." ControlToValidate="TextBoxContrasenya"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:CompareValidator ID="CompareValidatorConfirmContrasenya" runat="server" ErrorMessage="Les contrasenyes no coincideixen." ControlToValidate="TextBoxConfirmContrasenya" ControlToCompare="TextBoxContrasenya"></asp:CompareValidator>
        <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorMail" runat="server" ErrorMessage="El correu electrònic es obligatori." ControlToValidate="TextBoxMail"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:Label ID="LabelErrorPanelUsuari" runat="server" CssClass="labelError"></asp:Label>
    </asp:Panel>
    <asp:Panel ID="PanelUsuaris" runat="server" CssClass="panel">
        ...
        <asp:Label ID="LabelErrorPanelUsuaris" runat="server" CssClass="labelError"></asp:Label>
        <br /><br />
